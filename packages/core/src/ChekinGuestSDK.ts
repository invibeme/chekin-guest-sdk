...
export class ChekinGuestSDK {
  ...
  private config: ChekinGuestSDKConfig;
  private observer: MutationObserver | null = null;
  private readonly logger: ChekinLogger;
  private pendingPostMessageConfig?: Partial<ChekinGuestSDKConfig>;
  private readonly validator: ChekinSDKValidator;

  constructor(
    config: ChekinGuestSDKConfig & {
  ...
  private setupEventListeners(): void {
    ...
    // Set up guest-specific event callbacks from config
    if (this.config.onGuestRegistered) {
